	...
	<div class="edit-box">
		...
		<div class="options">
			...
			<el-scrollbar max-height="150px">
				<el-row class="tag-row">
					<el-col draggable="true" v-for="tag in tagList" :key="tag.name" :span="4"
						@dragstart="(e) => onDragstart(e, tag)" @drag="(e) => onDrag(e)">
						<div class="tag-box">
							<div class="icon">
								<el-icon size="16px">
		...
		<div class="options">
			<el-scrollbar max-height="170px" v-if="config.dragTagList.length">
				<div class="option" :class="activeTag.uuid == tag.uuid ? 'option-active' : ''" @click="onChooseTag(tag)"
					v-for="tag in config.dragTagList" :key="tag.uuid">
					<div class="icon-name">
						{{ tag.innerText }}
					</div>
					<el-space>
		...
		<div class="options" v-if="activeTag.uuid">
			<div class="option">
				...
				<div class="grid-silder">
					<el-slider @input="onChangeTagValue" show-input v-model="activeTag.height" :min="1" :max="500"
						:step="1" />
				</div>
			</div>
			<div class="option">
				...
				<div class="grid-silder">
					<el-slider @input="onChangeTagValue" show-input v-model="activeTag.width" :min="1" :max="500"
						:step="1" />
				</div>
			</div>
			<div class="option">
				...
				<div class="grid-silder">
					<el-slider @input="onChangeTagValue" show-input v-model="activeTag.fontSize" :min="1" :max="50"
						:step="0.1" />
				</div>
			</div>
			<div class="option">
				...
				<div class="grid-silder">
					<el-slider @input="onChangeTagValue" show-input v-model="activeTag.positionX" :min="-50" :max="50"
						:step="0.01" />
				</div>
			</div>
			<div class="option">
				...
				<div class="grid-silder">
					<el-slider @input="onChangeTagValue" show-input v-model="activeTag.positionY" :min="-50" :max="50"
						:step="0.1" />
				</div>
			</div>
			<div class="option">
				...
				<div class="grid-silder">
					<el-slider @input="onChangeTagValue" show-input v-model="activeTag.positionZ" :min="-50" :max="50"
						:step="0.1" />
				</div>
			</div>
			<div class="option">
				...
				<div class="grid-silder">
					<el-color-picker color-format="hex" :predefine="predefineColors" @change="onChangeTagValue"
			...
			<div class="option">
				...
				<div class="grid-silder">
					<el-slider @input="onChangeTagValue" show-input v-model="activeTag.iconSize" :min="1" :max="50"
						:step="0.1" />
				</div>
			</div>
			<div class="option" :style="{ height: 'auto' }">
				...
				<div class="grid-silder">
					<el-input type="textarea" :autosize="{ minRows: 3, maxRows: 3 }" @input="onChangeTagValue"
