  ...
  <div class="model-page">
    ...
    <header class="model-header">
      ...
      <div class="header-lr">
        <el-space>
          ...
          <el-button type="primary" icon="Document" v-if="handleConfigBtn" @click="onSaveConfig">
            保存数据
          </el-button>
          <el-button type="primary" icon="View" v-if="handleConfigBtn" @click="onPrivew">
            效果预览
          </el-button>
          ...
          <!-- <el-button
            ...
            @click="onImportantCode">
            嵌入代码
          </el-button> -->
          <el-button type="primary" size="small" icon="FullScreen" @click="onFullScreen">
    ...
    <div class="model-container">
      ...
      <div class="edit-panel" :style="{ minWidth: '380px' }">
        <ModelEditPanel ref="editPanel" v-if="store.modelApi.model" />
      </div>
    </div>
    <PageLoading :loading="loading" :percentage="progress" />
    <!-- 嵌入代码弹框 -->
    <ImplantCodeDialog ref="implatDialog" />
  </div>
</template>
